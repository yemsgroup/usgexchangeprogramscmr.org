<main class="">
    ...
    <div class="d-none container-fluid bg-custom-primary text-white">
    ...
    <div class="container my-5 py-5">
        <div class="row row-cols-lg-3 justify-content-center">
            ...
            <div class="col-12">
                <h3 class="mb-4 text-center text-custom-secondary text-uppercase">From our News Center</h3>
            </div>
            <?php Feature::list_features('News', $params = ['limit' => 3]); ?>

            <div class="mt-5 col-lg-8 text-center">
